...
} from "../../RTKBackend/ApiSlices/UploadImagesSlice";
          ...
          <View style={styles.frame1}>
            <View style={styles.main_header}>
              <View>
                <Ionicons
                  ...
                  style={styles.header_menubar_size}
                  name="menu"
                  size={28}
                  color="#FFFFFF"
                />
            ...
            <View style={styles.profile_area}>
              ...
              <View style={styles.profile_text}>
                ...
                <Text style={styles.profile_text_color_second}>
            ...
            <View style={styles.quick_action_text}>
              <Text style={styles.quick_action_text_edit}>
                Your Quick Actions
              </Text>
            </View>
            <View style={styles.quick_actions_bars}>
              ...
              >
                <View style={styles.appoint_image}>
                  <Image
                    style={styles.appoint_image_size}
                    source={require("../images/specialists.png")}
                  ></Image>
                </View>
                <View>
            ...
            <View style={styles.liver_capacity}>
              ...
              <View style={styles.liver_capacity_internal_text}>
                <Text style={styles.liver_capacity_internal_text_h1}>
                  {" "}
                  Liver Capacity
                </Text>
                <Text style={styles.liver_capacity_internal_text_h2}>
                  Based on your{" "}
                </Text>
                <Text style={styles.liver_capacity_internal_text_h3}>
                  last test
                </Text>
              </View>
              <View>
                <ImageBackground
                  style={styles.liver_image}
                  source={require("../images/liverdiary.png")}
                />
              </View>
            </View>
